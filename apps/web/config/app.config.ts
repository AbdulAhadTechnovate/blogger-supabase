...
// Ensure theme colors are different
const defaultThemeColor = process.env.NEXT_PUBLIC_THEME_COLOR || '#ffffff';
const defaultThemeColorDark =
  process.env.NEXT_PUBLIC_THEME_COLOR_DARK || '#0a0a0a';

// If both are set to the same value, use defaults
const themeColor =
  defaultThemeColor === defaultThemeColorDark ? '#ffffff' : defaultThemeColor;
const themeColorDark =
  themeColor === defaultThemeColorDark ? '#0a0a0a' : defaultThemeColorDark;
